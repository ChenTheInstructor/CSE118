...
public class MenuSystemEnhancedSwitch {
	...
	public static void main(String[] args) {
		...
		switch (choice) {
		case 1, 11, 111, 1111 -> System.out.printf("The balance is: $%.2f%n", balance);
		case 2, 22 -> {
		...
		case 4 -> System.out.println("Thank you for using our service. Goodbye!");
